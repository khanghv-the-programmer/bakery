                  ...
                  <div className="item-blog">
                    ...
                    <div className="block-content">
                      ...
                      <p className="justify line-clamp line-clamp-3">
                        &nbsp;Nhắc đến bánh Donut, dân sành thưởng thức hẳn không
                        còn xa lạ gì với món ăn vặt rất phổ biến ở các nước phương
                        Tây này. Dù có nguồn...
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="item-blog">
                    ...
                    <div className="block-content">
                      ...
                      <p className="justify line-clamp line-clamp-3">
                        ...
                        trưng lại còn đưa miệng với độ giòn xốp, dai dai từ "ngàn"
                        lớp bánh. Nổi bật với hình...
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="block-content">
                      <h3>
                        <a
                          ...
                          title="Bánh ngọt - Các loại bánh ngọt được ưa chuộng tại Dola"
                        >
                          Bánh ngọt - Các loại bánh ngọt được ưa chuộng tại Dola
                        </a>
                      </h3>
                      <p className="justify line-clamp line-clamp-3">
                  ...
                  <div className="item-blog">
                    ...
                    <div className="block-content">
                      ...
                      <p className="justify line-clamp line-clamp-3">
                        ...
                        được nhiều người tiêu dùng ưa thích lựa chọn. Không giống
                        những loại bánh khác, bánh quy đặc biệt với hương...
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <ul className="nav navbar-pills">
                  ...
                  <li className="nav-item  relative">
                    ...
                    <ul className="menu_down" style={{ display: "none" }}>
                      ...
                      <li className="nav-item">
                        <a title="Đồ uống" className="nav-link" href="/do-uong">
                          Đồ uống
                        </a>
                      </li>
                    </ul>
