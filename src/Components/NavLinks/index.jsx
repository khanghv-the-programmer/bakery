...
const NavLinks = () => {
  ...
  const [previousMouseOverProduct, setPreviousMouseOverProduct] = useState(false);
  ...
  return (
    <>
      <div className={`menu-container ${showMenu ? "hSticky" : ""}`}>
        <div className="container">
          <div className="row row-hear align-items-center">
            ...
            <div className="col-lg-2 menu-control">
              ...
              <div className="icon">
                <NavLink className="icon-login" onMouseMove={handlerMouseEnterLogin}><FaRegUser style={{ fontSize: "25px" }} /></NavLink>
              </div>
              <div className="icon">
                <NavLink to={"/heart"}>
                  {" "}
        ...
        <div
          className={`list-category ${isHoveredProduct ? "" : "d-none"}`}
